...
*play-httpmock* is a "play! framework":http://playframework.org module allowing you to cache WebService responses to overcome connection problems (lag, denial of service, HTTP errors) for fast developping.
